...
The following paragraphs will give an overview of the problem, the dataset, and the adopted methodology. You can skip to the instructions by clicking [here](https://github.com/FrancescaBellucci/mlops-zoomcamp/edit/main/final_project/README.md##Instructions)
